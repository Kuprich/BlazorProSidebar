...
let SUB_MENU_ELS = document.querySelectorAll(
...
let INNER_SUB_MENUS_BTN = document.querySelectorAll(
...
function btnCollapseClick() {
    ...
    console.log("#btn-collapse clicked")
...
function onInitialize() {
    ...
    console.log("OnInitializedAsync")

    SIDEBAR_EL = document.getElementById("sidebar");

    PoppersInstance = new Poppers();
